...
public class ServiceController {
  ...
  // - Spring framework에서 @Autowired를 이용하여 의존성 주입을 Spring에게 위임할 수 있음 (IoC, DI)
  ...
  // - 주의! : IoC를 통해 Spring에게 의존성 주입을 의임하려면 주입하려는 클래스가 Spring Bean으로 등록(@Component)되어 있어야함
  ...
  // 생성자를 이용한 의존성 주입 방법을 사용할 땐 @Autowired를 생략해도 됨(권장사항이기 때문)
  // @Autowired(생략 가능)
